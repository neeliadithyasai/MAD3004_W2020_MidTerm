...
class Mobile:Bill
{
    ...
    init(Bill_Id: Int, Bill_Date: Date, Bill_Type: String, Total_Bill_Amount: Double,Mobile_Manufacturer_Name: String, Plan_Name: String, Mobile_Number: Int, Internet_GB_Used: Double, Minutes_Used: Double) {
